...
class _BottomToolsState extends State<BottomTools> {
  /// Set once the share button is pressed. Rendering the canvas and uploading
  /// take a moment with no visible change, so the button gets tapped again —
  /// and each tap was posting another copy of the same story.
  bool _sharing = false;
