          ...
          child: IntrinsicHeight(
            child: Container(
              ...
              child: AnimatedOnTapButton(
                ...
                child: Container(
                  padding: draggableWidget.backGroundColor == Colors.transparent
                      ? EdgeInsets.zero
  ...
  _textStyle(
    ...
    return TextStyle(
      ...
      fontWeight: FontWeight.w500,
        ...
        // No paint background: the chip is a real Container now, so it can
        // carry the design's 12 padding and 8 corner radius.
        );
  }
