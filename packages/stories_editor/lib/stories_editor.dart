...
export 'src/presentation/bar_tools/top_tools.dart' show StoryPlaceResolver;
...
class StoriesEditor extends StatelessWidget {
  ...
  /// Resolves the story's place label for the toolbar's place button. Null
  /// hides that button — the editor cannot read EXIF or reverse-geocode on its
  /// own, the app supplies both.
  ...
  /// Image the editor opens with, already on the canvas.
  ///
  /// Without it the editor starts on the blank gradient background, which is
  /// wrong when the user just took a picture to edit.
