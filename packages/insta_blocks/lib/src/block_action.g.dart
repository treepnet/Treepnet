...
NavigateToPostAuthorProfileAction _$NavigateToPostAuthorProfileActionFromJson(
  ...
  ($checkedConvert) {
    final val = NavigateToPostAuthorProfileAction(
      ...
      type: $checkedConvert(
        'type',
        (v) => v as String? ?? NavigateToPostAuthorProfileAction.identifier,
      ),
    );
    return val;
  },
...
) => <String, dynamic>{'author_id': instance.authorId, 'type': instance.type};
...
UnknownBlockAction _$UnknownBlockActionFromJson(Map<String, dynamic> json) =>
    $checkedCreate('UnknownBlockAction', json, ($checkedConvert) {
