...
PostReelBlock _$PostReelBlockFromJson(Map<String, dynamic> json) =>
    $checkedCreate('PostReelBlock', json, ($checkedConvert) {
      final val = PostReelBlock(
        id: $checkedConvert('id', (v) => v as String),
        author: $checkedConvert(
          'author',
          (v) =>
              const PostAuthorConverter().fromJson(v as Map<String, dynamic>),
        ),
        ...
        media: $checkedConvert(
          'media',
          (v) => const ListMediaConverterFromRemoteConfig().fromJson(v as List),
        ),
        ...
        type: $checkedConvert(
          'type',
          (v) => v as String? ?? PostReelBlock.identifier,
        ),
...
Map<String, dynamic> _$PostReelBlockToJson(
  PostReelBlock instance,
) => <String, dynamic>{
  'type': instance.type,
