...
class AppDarkTheme extends AppTheme {
  ...
  @override
  // Figma page background (#191919) rather than pure black.
  ...
  ThemeData get theme =>
      FlexThemeData.dark(
        scheme: FlexScheme.custom,
        // The design uses one flat page colour (#191919); true black made the
        // scaffold pure #000 behind Home and Search.
        ...
        // The bar only set `type` before, so it fell back to the scheme's
        // surface colour instead of the design's page colour.
        bottomNavigationBarTheme: const BottomNavigationBarThemeData(
          type: BottomNavigationBarType.fixed,
          backgroundColor: AppColors.background,
          elevation: 0,
          selectedItemColor: AppColors.white,
          // Design: every nav icon is white; the active tab is distinguished
          // by its filled variant, not by a duller colour.
        ...
        // Dialogs and popup menus default to the page colour too, so a new
        // screen can't reintroduce an off-palette surface by omission.
