...
class AppScaffold extends StatelessWidget {
  ...
  const AppScaffold({
    ...
    // Matches Scaffold's own default, which is what every caller has been
    // getting until now: the field existed but was never wired through, so it
    // did nothing. Screens that want the keyboard to overlay rather than shrink
    // the body pass false explicitly.
