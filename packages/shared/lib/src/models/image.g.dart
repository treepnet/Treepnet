...
ImageMedia _$ImageMediaFromJson(Map<String, dynamic> json) =>
    $checkedCreate('ImageMedia', json, ($checkedConvert) {
      final val = ImageMedia(
        ...
        type: $checkedConvert(
          'type',
          (v) => v as String? ?? ImageMedia.identifier,
        ),
      );
      return val;
...
MemoryImageMedia _$MemoryImageMediaFromJson(Map<String, dynamic> json) =>
    $checkedCreate('MemoryImageMedia', json, ($checkedConvert) {
      final val = MemoryImageMedia(
        bytes: $checkedConvert(
          'bytes',
          (v) => const UintConverter().fromJson(v as List<int>),
        ),
        id: $checkedConvert('id', (v) => v as String),
        url: $checkedConvert('url', (v) => v as String? ?? ''),
        type: $checkedConvert(
          'type',
          (v) => v as String? ?? MemoryImageMedia.identifier,
        ),
      );
      return val;
    });
