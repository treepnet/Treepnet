...
import 'package:treepnet/comments/view/comments_page.dart';
import 'package:treepnet/feed/post/post.dart';
import 'package:treepnet/feed/post/view/newest_posts_page.dart';
...
class PostPopup extends StatelessWidget {
  ...
  /// The feed a tap should scroll through. Null falls back to the newest posts
  /// across everyone — right for explore and a profile, wrong for a place.
    ...
    return ValueListenableBuilder<bool>(
      ...
      builder: (context, isLiked, child) {
        return Tappable.faded(
          ...
          // A tap opens a scrollable feed of the newest posts starting on this
          // one — not just this single post.
          onTap: () => Navigator.of(context, rootNavigator: true).push<void>(
            MaterialPageRoute(
              builder: (_) => NewestPostsPage(
                startPostId: widget.block.id,
