...
final class PostIsBookmarkedSubscriptionRequested extends PostEvent {
  const PostIsBookmarkedSubscriptionRequested();
}

final class PostBookmarkRequested extends PostEvent {
  const PostBookmarkRequested();
}
